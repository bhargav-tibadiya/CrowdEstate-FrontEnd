...
import styles from "./Indivisual.module.scss"
...
const IndivisualProperty = () => {
    ...
    return (
        <div className={styles.indivisual_properties_container}>
...
export default IndivisualProperty