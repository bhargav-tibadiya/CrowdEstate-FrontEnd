// import { FaArrowDown, FaArrowUp, FaDollarSign, FaMoneyBillWave, FaUser } from "react-icons/fa";
...
const Dashboard = () => {
    ...
    const monthlyData = aggregateTransactionsByMonth(data);
    const YearlyData = aggregateTransactionsByYear(data);
    ...
    const categoryCounts = data.reduce((ele, property) => {
